...
class LargeCoreMMF(Fiber):
    ...
    def calculate_matrix(self, L=None, kappa_vals = None, theta_vals = None, splice_every = -1):
        """
        ...
        for section in range(n_sections):
            ...
            if splice_every > 0 and section % splice_every == 0:
                filename1 = 'small core lossy projectiom matrix constant offset 2'+str(section/splice_every)
                f1 = open(filename1,'r')
                Mi = pickle.load(f1)
            else:
